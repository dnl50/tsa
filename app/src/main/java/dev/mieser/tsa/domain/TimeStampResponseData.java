...
public class TimeStampResponseData {
    ...
    public static TimeStampResponseDataBuilder builder(ResponseStatus status,
        ZonedDateTime receptionTime,
        TimeStampRequestData request,
        byte[] asnEncoded) {
        return new TimeStampResponseDataBuilder()
            .status(status)
            .receptionTime(receptionTime)
            .request(request)
            .asnEncoded(asnEncoded);
    }
