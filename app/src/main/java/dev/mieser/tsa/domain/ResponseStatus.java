...
/**
 * Enumeration of all status values a compliant TSAs should produce according to
...
public enum ResponseStatus {
    ...
    /**
     * @param value
     *     The value the corresponding {@link ResponseStatus} should be returned for.
     * @return An optional containing the corresponding {@link ResponseStatus} or {@link Optional#empty()} when no
     * corresponding enum constant is defined.
     */
