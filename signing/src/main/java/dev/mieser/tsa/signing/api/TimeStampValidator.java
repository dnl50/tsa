...
/**
 * Interface abstraction of a service verifying that <a href="https://www.ietf.org/rfc/rfc3161.txt">RFC 3161</a> Time-Stamp Protocol responses were signed by
 * the corresponding {@link TimeStampAuthority} implementation.
 */
public interface TimeStampValidator {
     ...
     *
     * @throws TsaInitializationException When an error occurs while initializing the validator.
     */
    void initialize();
     ...
     *
     * @param tspResponseInputStream The input stream of an ASN.1 DER encoded TSP request, not {@code null}.
