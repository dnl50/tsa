...
public class PublicKeyAnalyzer {
    ...
    /**
     * @param certificate The certificate which contains the public key to retrieve the algorithm from, not {@code null}.
     * @return The algorithm of the public key.
     * @throws IllegalArgumentException When no known {@link PublicKeyAlgorithm} exists for the specified public key.
     */
